...
Write-Host "Creating Azure Search Blob Storage Datasource from $storageAccountName" -ForegroundColor Yellow
Write-Host "-------------------------------------------------------- " -ForegroundColor Yellow

. ".\Deploy-Create-Datasource.ps1"
CreateDatasource -resourceGroupName $resourceGroupName -azsearchDatasourceName $azsearchDatasourceName -storageAccountName `
                $storageAccountName -storageContainerName $storageContainerName
...
CreateSkillset -resourceGroupName $resourceGroupName `
